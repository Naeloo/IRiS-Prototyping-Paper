...
\newcommand{\stdgraphic}[3]{\begin{figure}[h]\caption{#2\imgsrc{#3}}\centering\includegraphics[width=0.5\textwidth]{#1}\end{figure}}
\newcommand{\stdgraphicnosrc}[2]{\begin{figure}[h]\caption{#2}\centering\includegraphics[width=0.5\textwidth]{#1}\end{figure}}
...
\lstloadlanguages{[ANSI]C, C++, [gnu]make, gnuplot, Matlab, Java}
